 ...
 * 错误类型定义
 */
export declare class MCPDeploymentError extends Error {
    code: string;
...
export declare class ConfigurationError extends Error {
    ...
    details?: any | undefined;
    constructor(message: string, configPath?: string | undefined, details?: any | undefined);
}
 ...
 * 事件类型
 */
export type EventType = "server_deployed" | "server_removed" | "config_updated" | "backup_created" | "validation_failed" | "system_error";
/**
 * 事件数据
 */
